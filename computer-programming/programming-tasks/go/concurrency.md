...
# Determine if only one instance is running<a id="sec-6"></a>
...
# Checkpoint synchronization<a id="sec-8"></a>
...
# Metered concurrency<a id="sec-10"></a>
